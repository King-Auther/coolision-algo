...
function draw() {
  ...
  if(moving_rect.x-fixed_rect.x<=
    fixed_rect.width/2+moving_rect.width/2 &&
    fixed_rect.x-moving_rect.x<=
    fixed_rect.width/2+moving_rect.width/2&&
    moving_rect.y-fixed_rect.y<=
    fixed_rect.height/2+moving_rect.height/2&&
    fixed_rect.y-moving_rect.y<=
    fixed_rect.height/2+moving_rect.height/2){
